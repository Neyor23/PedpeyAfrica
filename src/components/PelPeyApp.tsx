            ...
            {filteredArticles.length ? (
              <div className="mt-9 grid min-w-0 grid-cols-1 gap-x-5 gap-y-10 sm:mt-12 sm:grid-cols-2 lg:grid-cols-3 lg:gap-y-12">
                {filteredArticles.map((article) => (
                   <div key={article.title} onClick={() => { window.location.href = "/article/" + encodeURIComponent(article.title) }} className="article-card group min-w-0 text-left cursor-pointer" style={{pointerEvents: 'auto', position: 'relative', zIndex: 10}}>

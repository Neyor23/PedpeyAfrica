  ...
  if (!article) {
    return (
      <div className="p-20 text-center">
        ...
        <p className="mt-2">Searched: {articleId} → Cleaned: {cleanId}</p>
        <p className="text-sm text-gray-400">Available: {articlesData.map(a => a.id).join(', ')}</p>
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-8 pb-20">
        <div className="bg-white rounded-[20px] shadow-xl overflow-hidden">
          ...
          <div className="p-8 md:p-12">
            <p className="text-xl text-gray-600 italic border-l-4 border-[#f4b400] pl-4 mb-8">{article.excerpt}</p>
